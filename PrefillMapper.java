package com.itr1.calculator.mapper;
...
public class PrefillMapper {
    ...
    private void mapSalary(JsonNode root, PreFillData data) {
        ...
        if (!incDed.isMissingNode() && !incDed.isNull()) {
            ...
            // Employer details from salaries array
            ...
            data.tdsSalary = longVal(incDed, "deductionUs16ia"); // placeholder; overridden below
        } else {
        ...
        // Professional tax (16iii) from form24q
